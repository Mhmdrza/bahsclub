  ...
  return (
    <div className="space-y-6" dir="rtl">
      <div className="border-b border-border pb-4">
        ...
        <p className="text-xs text-muted mt-1">چالش‌ها را بر اساس حوزه اندیشه‌ای و تگ کاوش کنید</p>
      </div>
      ...
      {tags.length === 0 ? (
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3">
          {tags.map((t: unknown) => {
            const tag = t as { id: number; slug: string; name: string; challenge_count: number };
            return (
              <Link
                key={tag.id}
