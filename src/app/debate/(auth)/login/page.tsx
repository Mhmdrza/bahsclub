...
export default function LoginPage() {
  ...
  return (
    <div className="max-w-sm mx-auto mt-16">
      <h1 className="text-2xl font-bold mb-1" style={{ color: "#1A1A1D" }}>ورود</h1>
      <p className="text-sm mb-6" style={{ color: "#5C5C63" }}>با نام کاربری و رمز عبور وارد شوید</p>
      ...
      <p className="text-sm mt-4 text-center" style={{ color: "#5C5C63" }}>
        حساب ندارید؟ <Link href="/debate/register" style={{ color: "#D93B3B" }}>ثبت‌نام</Link>
      </p>
    </div>
  );
}