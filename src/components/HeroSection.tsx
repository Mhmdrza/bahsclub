...
const VARIANTS: HeroVariant[] = [
  ...
  },
  {
    ...
    body: "خیلی از disagreements از این می‌آید که فقط منتظر نوبت حرف زدن خودمان هستیم. اینجا قدم‌به‌قدم یاد می‌گیری چطور سؤال بهتر بپرسی، حرف طرف مقابل را درست بفهمی، و بدون تحقیر اختلاف را بررسی کنی. هر درس، یک ابزار تازه برای گفت‌وگوی بعدی‌ات.",
    bodyStrong: "گفت‌وگوی خوب یک مهارت است — و قابل یادگیری.",
  },
  {
    eyebrow: "یک اعتراف کوچک",
    heading: "بیشتر ما بحث کردن را از محیط‌های پرتنش یاد گرفته‌ایم",
  ...
  },
  {
    ...
    body: "این دو مسیر به جاهای کاملاً متفاوتی می‌رسند. آموزش‌های ما کمکت می‌کنند فروتنی فکری را تمرین کنی، از مغالطه‌های رایج دوری کنی، و با اعتمادبه‌نفس بگویی «نمی‌دانم». هر مبحث، یک قدم به سمت حرف زدنِ شفاف‌تر و صادقانه‌تر.",
    bodyStrong: "حرف زدن خوب، تمرین می‌خواهد — از همین‌جا شروع کن.",
  },
];
